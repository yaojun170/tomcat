...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public void bind() throws Exception {
        ...
        if (!getUseInheritedChannel()) {
            ...
            serverSock.socket().bind(addr,getAcceptCount());//绑定端口，但尚未使用accept获取客户端连接
        } else {
        ...
        serverSock.configureBlocking(true); //mimic APR behavior//?阻塞式的接受连接？
    ...
    public void startInternal() throws Exception {
        ...
        if (!running) {
            ...
            initializeConnectionLatch();//设置最大连接数限制
            ...
            while (running) {
                ...
                try {
                    ...
                    if (running && !paused) {
                        ...
                        if (!setSocketOptions(socket)) {//**socket连接处理
                            closeSocket(socket);
                        }
                    } else {
                        closeSocket(socket);
        ...
        public void run() {
            ...
            while (true) {
                ...
                while (iterator != null && iterator.hasNext()) {
                    ...
                    // cancelledKey()
                    if (socketWrapper != null) {
                        processKey(sk, socketWrapper);//**处理检测到的IO事件
                    }
                }
